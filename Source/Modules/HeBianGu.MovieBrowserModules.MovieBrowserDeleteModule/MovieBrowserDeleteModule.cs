 ...
 * ========================================================================
 *    
 * 作者：[李海军]   时间：2018/4/4 14:39:56 
 * 文件名：MovieBrowserDeleteModule 
 * 说明：
 * 
 * 
 * 修改者：           时间：               
...
namespace HeBianGu.MovieBrowserModules.MovieBrowserDeleteModule
{
    [ModuleExport(typeof(MovieBrowserDeleteModule))]
    public class MovieBrowserDeleteModule : IModule
    {
