...
{
    [ModuleExport(typeof(SaveBoardModule))]
    public class SaveBoardModule : IModule
    {
        [Import]
        ...
        public void Initialize()
        {
            ...
            this.RegionManager.RegisterViewWithRegion(RegionNames.MainNavigationRegion, typeof(View.NavigationSaveBar));
        }
    }
}
