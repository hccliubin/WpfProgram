 ...
 * ========================================================================
 *    
 * 作者：[李海军]   时间：2017/11/29 13:39:18 
 * 文件名：IntergrationToolModule 
 * 说明：
 * 
 * 
 * 修改者：           时间：               
...
namespace IntergrationToolModule
{
    [ModuleExport(typeof(IntergrationToolModule))]
    public class IntergrationToolModule : IModule
    {
        [Import]
        ...
        public void Initialize()
        {
            ...
            this.RegionManager.RegisterViewWithRegion(RegionNames.MainNavigationRegion, typeof(View.NavigationBar));
        }
    }
}
