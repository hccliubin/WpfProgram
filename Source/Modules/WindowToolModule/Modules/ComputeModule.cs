...
namespace WindowToolModule.Modules
{
    ...
    [ModuleExport(typeof(ComputeModule))]
    public class ComputeModule : IModule
    {
        [Import]
        ...
        public void Initialize()
        {
            ...
            this.RegionManager.RegisterViewWithRegion(RegionNames.MainToolRegion, typeof(View.ComputeTool));
        }
    }
}
