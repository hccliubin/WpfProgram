...
namespace WindowToolModule.Modules
{
    ...
    [ModuleExport(typeof(RegeditModule))]
    public class RegeditModule : IModule
    {
        [Import]
        ...
        public void Initialize()
        {
            ...
            this.RegionManager.RegisterViewWithRegion(RegionNames.MainToolRegion, typeof(View.RegeditTool));
        }
    }
}
