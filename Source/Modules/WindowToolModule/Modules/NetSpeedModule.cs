...
namespace WindowToolModule.Modules
{
    ...
    [ModuleExport(typeof(NetSpeedModule))]
    public class NetSpeedModule : IModule
    {
        [Import]
        ...
        public void Initialize()
        {
            ...
            this.RegionManager.RegisterViewWithRegion(RegionNames.MainToolRegion, typeof(View.NetSpeedTool));
        }
    }
}
