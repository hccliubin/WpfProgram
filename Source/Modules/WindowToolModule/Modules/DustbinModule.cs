...
namespace WindowToolModule.Modules
{
    ...
    [ModuleExport(typeof(DustbinModule))]
    public class DustbinModule : IModule
    {
        [Import]
        ...
        public void Initialize()
        {
            ...
            this.RegionManager.RegisterViewWithRegion(RegionNames.MainToolRegion, typeof(View.DustbinTool));
        }
    }
}
