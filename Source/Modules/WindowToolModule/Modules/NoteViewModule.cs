...
namespace WindowToolModule.Modules
{
    ...
    [ModuleExport(typeof(NoteViewModule))]
    public class NoteViewModule : IModule
    {
        [Import]
        ...
        public void Initialize()
        {
            ...
            this.RegionManager.RegisterViewWithRegion(RegionNames.MainToolRegion, typeof(View.NotePadTool));
        }
    }
}
