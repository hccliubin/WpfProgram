...
namespace WindowToolModule.Modules
{
    ...
    [ModuleExport(typeof(MstscModule))]
    public class MstscModule : IModule
    {
        [Import]
        ...
        public void Initialize()
        {
            ...
            this.RegionManager.RegisterViewWithRegion(RegionNames.MainToolRegion, typeof(View.MstscTool));
        }
    }
}
