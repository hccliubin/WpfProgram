    ...
    public class PaletteHelper
    {
        public virtual void SetLightDark(bool isDark)
        {
            var existingResourceDictionary = Application.Current.Resources.MergedDictionaries
                ...
                .SingleOrDefault(rd => Regex.Match(rd.Source.OriginalString, @"(\/HeBianGu.Control.MaterialControl;component\/Themes\/Themes\/MaterialDesignTheme\.)((Light)|(Dark))").Success);
            if (existingResourceDictionary == null)
                throw new ApplicationException("Unable to find Light/Dark base theme in Application resources.");

            var source =
                $"pack://application:,,,/HeBianGu.Control.MaterialControl;component/Themes/Themes/MaterialDesignTheme.{(isDark ? "Dark" : "Light")}.xaml";
