...
namespace HeBianGu.Controls.MaterialControl
{
    internal static class ShadowInfo
    {
        ...
        static ShadowInfo()
        {
            var resourceDictionary = new ResourceDictionary { Source = new Uri("pack://application:,,,/HeBianGu.Control.MaterialControl;component/Themes/Themes/MaterialDesignTheme.Shadows.xaml", UriKind.Absolute) };
