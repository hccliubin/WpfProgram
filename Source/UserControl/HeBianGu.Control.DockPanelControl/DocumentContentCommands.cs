        ...
        public static RoutedUICommand FloatingDocument
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        _floatingDocumentCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DocumentContentCommands_FloatingDocument, "FloatingDocument", typeof(DocumentContentCommands));
                    }
                }
        ...
        public static RoutedUICommand TabbedDocument
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        _tabbedDocumentCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DocumentContentCommands_TabbedDocument, "TabbedDocument", typeof(DocumentContentCommands));
                    }
                }
