        ...
        public static RoutedUICommand Close
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        closeCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DockablePaneCommands_Close, "Close", typeof(DockablePaneCommands));
                    }
                }
                return closeCommand;
            }
        ...
        public static RoutedUICommand Hide
        {
            get
            {
                lock (syncRoot)
                {
                    if (null == hideCommand)
                    {
                        hideCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DockablePaneCommands_Hide, "Hide", typeof(DockablePaneCommands));
                    }
                }
                return hideCommand;
            }
        ...
        public static RoutedUICommand ToggleAutoHide
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        autoHideCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DockablePaneCommands_ToggleAutoHide, "AutoHide", typeof(DockablePaneCommands));
                    }
                }
