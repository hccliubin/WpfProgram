        ...
        public static RoutedUICommand SetAsDockableWindow
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        dockableCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DockableContentCommands_DockableFloatingWindow, "DockableWindow", typeof(DockableFloatingWindowCommands));
                    }
                }
        ...
        public static RoutedUICommand SetAsFloatingWindow
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        floatingCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DockableContentCommands_FloatingWindow, "FloatingWindow", typeof(DockableFloatingWindowCommands));
                    }
                }
