        ...
        public static RoutedUICommand ShowAsDocument
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        documentCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DockableContentCommands_ShowAsDocument, "Document", typeof(DockableContentCommands));
                    }
                }
        ...
        public static RoutedUICommand FloatingWindow
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        floatingWindowCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DockableContentCommands_FloatingWindow, "FloatingWindow", typeof(DockableContentCommands));
                    }
                }
        ...
        public static RoutedUICommand DockableFloatingWindow
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        dockableWindowCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DockableContentCommands_DockableFloatingWindow, "DockableFloatingWindow", typeof(DockableContentCommands));
                    }
                }
        ...
        public static RoutedUICommand ToggleAutoHide
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        autoHideCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DockableContentCommands_ToggleAutoHide, "AutoHide", typeof(DockableContentCommands));
                    }
                }
