        ...
        public static RoutedUICommand CloseAllButThis
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        closeAllButThisCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DocumentPaneCommands_CloseAllButThis, "CloseAllButThis", typeof(DocumentPaneCommands));
                    }
                }
        ...
        public static RoutedUICommand CloseThis
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        closeThisCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DocumentPaneCommands_CloseThis, "Close", typeof(DocumentPaneCommands));
                    }
                }
        ...
        public static RoutedUICommand NewHorizontalTabGroup
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        newHTabGroupCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DocumentPaneCommands_NewHorizontalTabGroup, "NewHorizontalTabGroup", typeof(DocumentPaneCommands));
                    }
                }
        ...
        public static RoutedUICommand NewVerticalTabGroup
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        newVTabGroupCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.DocumentPaneCommands_NewVerticalTabGroup, "NewVerticalTabGroup", typeof(DocumentPaneCommands));
                    }
                }
