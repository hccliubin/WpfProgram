        ...
        public static RoutedUICommand Close
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        closeCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.ManagedContentCommands_Close, "Close", typeof(ManagedContentCommands));
                    }
                }
                return closeCommand;
            }
        ...
        public static RoutedUICommand Hide
        {
            get
            {
                lock (syncRoot)
                {
                    if (null == hideCommand)
                    {
                        hideCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.ManagedContentCommands_Hide, "Hide", typeof(ManagedContentCommands));
                    }
                }
                return hideCommand;
            }
        ...
        public static RoutedUICommand Show
        {
            get
            {
                lock (syncRoot)
                {
                    if (null == showCommand)
                    {
                        showCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.ManagedContentCommands_Show, "Show", typeof(ManagedContentCommands));
                    }
                }
                return showCommand;
            }
        ...
        public static RoutedUICommand Activate
        {
            get
            {
                lock (syncRoot)
                {
                    ...
                    {
                        activateCommand = new RoutedUICommand(HeBianGu.Control.DockPanelControl.Properties.Resources.ManagedContentCommands_Activate, "Activate", typeof(ManagedContentCommands));
                    }
                }
